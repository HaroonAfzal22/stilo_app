...
class MyReservationsCanceled extends ConsumerStatefulWidget {
  const MyReservationsCanceled({Key? key}) : super(key: key);

  @override
  ConsumerState<MyReservationsCanceled> createState() =>
      _MyReservationsCanceledState();
}

class _MyReservationsCanceledState
    extends ConsumerState<MyReservationsCanceled> {
