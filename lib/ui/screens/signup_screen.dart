...
import '../../config/toastMessages.dart';
...
class _SignUpScreenState extends ConsumerState<SignUpScreen> {
  ...
  final Map<String, dynamic> _controllers = {
    ...
    'dateOfBirthF': TextEditingController(),
  };
  bool? value = false;
  List dataList = [];
  List _myActivities = [];
  ...
  bool validation() {
    _controllers['telephone'].text =
        _controllers['telephone'].text.replaceAll(' ', '');
    ...
    if (_controllers['name'].text.isEmpty) {
      ...
      return false;
    } else if (_controllers['password'].text.length < 8) {
      showredToast(password_8_char_long, context);
      return false;
    } else if (_controllers['confirmPassword'].text.isEmpty) {
      showredToast(translate(context, "err_confirm_password"), context);
      return false;
      ...
      return false;
    } else if (!isPasswordCompliant(_controllers['password'].text)) {
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                        controller: _controllers['dateOfBirthF'],
                        decoration: const InputDecoration(
                        ...
                        onTap: () async {
                          ...
                          if (pickedDate != null) {
                            ...
                            setState(() {
                              ...
                              _controllers['dateOfBirthF'].text =
