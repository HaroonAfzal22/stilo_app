...
class SettingsAddAddress extends StatefulWidget {
  const SettingsAddAddress({Key? key}) : super(key: key);
  static const routeName = '/settings-add-address';

  @override
  _SettingsAddAddressState createState() => _SettingsAddAddressState();
}

class _SettingsAddAddressState extends State<SettingsAddAddress> {
  ...
  validation() {
    if (_controllers['name'].text.length < 2) {
      ...
      return false;
    } else if (_controllers['lastName'].text.length < 3) {
      showredToast(translate(context, "err_lastname"), context);
      return false;
    } else if (_controllers['address'].text.length < 6) {
                          ...
                          child: DropdownButtonHideUnderline(
                            child: Padding(
                              ...
                              child: DropdownButtonFormField<String>(
                                hint: Text(
                                  translate(context, "select_adress_types"),
                                  style: AppTheme.h3Style.copyWith(
                                      fontSize: 10.0.sp, color: AppColors.grey),
                                ),
                                value: addressType,
                  ...
                  child: CustomOutlinedButton(
                    ...
                    onTap: () {
                      if (validation()) {
                        ...
                        _apisNew.createAddress(updatedAddress.toJson());
